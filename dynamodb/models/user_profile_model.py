...
class UserProfileModel(BaseModel):
    ...
    def from_dynamodb(cls, item: dict) -> "UserProfileModel":
        ...
        return cls(
            ...
            strava_token_expires_at=int(item['strava_token_expires_at']['N']) if 'strava_token_expires_at' in item else None,
            strava_connected_at=datetime.fromisoformat(item['strava_connected_at']['S']) if 'strava_connected_at' in item else None,
